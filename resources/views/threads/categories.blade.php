                    ...
                    <div class="tt-item">
                        <div class="tt-item-header">
                            <ul class="tt-list-badge">
                                <li><a href="/threads/category/{{$category->id}}"><span class="tt-color01 tt-badge">{{$category->category_name}}</span></a></li>
                            </ul>
                            <h6 class="tt-title"><a href="page-categories-single.html">Threads : {{$category->threads->count()}}</a></h6>
                        </div>
