            ...
            <div class="tt-tab-wrapper">
                <div class="tt-wrapper-inner">
                    <ul class="nav nav-tabs pt-tabs-default" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link " data-toggle="tab" href="#tt-tab-01"
                        ...
                        <li class="nav-item tt-hide-xs">
                            <a class="nav-link" data-toggle="tab" href="#tt-tab-04" role="tab"><span>526
                                    Followers</span></a>
                        </li>
                        <li class="nav-item tt-hide-md">
                            <a class="nav-link" data-toggle="tab" href="#tt-tab-05" role="tab"><span>489
                                    Following</span></a>
                        </li>
                        <li class="nav-item tt-hide-md">
                                ...
                                <div class="tt-col-description">
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col-11">
                                            <ul class="tt-list-badge">
                                                <li class="show-mobile"><a href="#"><span
                                                            class="tt-color15 tt-badge">nature</span></a></li>
                                                <li><a href="#"><span class="tt-badge">themeforest</span></a></li>
                                                <li><a href="#"><span class="tt-badge">elements</span></a></li>
                                            </ul>
                                        </div>
                        ...
                        <div class="tt-topic-list">
                            ...
                            <div class="tt-item">
                                ...
                                <div class="tt-col-description">
                                    ...
                                    <div class="tt-content">
                                        I really liked new badge - T-shirt. Will there be new contests with new badges
                                        for AudioJungle?
                                    </div>
                                </div>
                                <div class="tt-col-category"><a href="#"><span
                                            class="tt-color06 tt-badge">movies</span></a></div>
                                <div class="tt-col-value-large hide-mobile">5 Jan,19</div>
                            </div>
                            <div class="tt-item">
                                <div class="tt-col-avatar">
                                ...
                                <div class="tt-col-description">
                                    ...
                                    <div class="tt-content">
                                        Can it be in not vector format but in very big resolution (far far beyond enough
                                        for print on shirts) ?
                                    </div>
                                </div>
                                <div class="tt-col-category"><a href="#"><span
                                            class="tt-color15 tt-badge">nature</span></a></div>
                                <div class="tt-col-value-large hide-mobile">5 Jan,19</div>
                            </div>
                            <div class="tt-item">
                                <div class="tt-col-avatar">
                                ...
                                <div class="tt-col-description">
                                    ...
                                    <div class="tt-content">
                                        One more question -> what is the maximum space (in cm or inches) the design can
                                        be?
                                    </div>
                                </div>
                                <div class="tt-col-category"><a href="#"><span
                                            class="tt-color05 tt-badge">music</span></a></div>
                                <div class="tt-col-value-large hide-mobile">5 Jan,19</div>
                            </div>
                            <div class="tt-item">
                                <div class="tt-col-avatar">
                                ...
                                <div class="tt-col-description">
                                    ...
                                    <div class="tt-content">
                                        Wow great to see another good contest, I hope we will submit one of our entry
                                        this time and try to win it
                                    </div>
                                </div>
                                <div class="tt-col-category"><a href="#"><span
                                            class="tt-color05 tt-badge">music</span></a></div>
                            ...
                            <div class="tt-item">
                                ...
                                <div class="tt-col-description">
                                    ...
                                    <div class="tt-content">
                                        Keep an eye on author dashboard or forums and thr are chances for such contest
                                        in each and every category on Envato market
                                    </div>
                                </div>
                                <div class="tt-col-category"><a href="#"><span
                                            class="tt-color03 tt-badge">exchange</span></a></div>
                                <div class="tt-col-value-large hide-mobile">5 Jan,19</div>
                            </div>
                            <div class="tt-item">
                                <div class="tt-col-avatar">
                                ...
                                <div class="tt-col-category"><a href="#"><span
                                            class="tt-color08 tt-badge">youtube</span></a></div>
                                <div class="tt-col-value-large hide-mobile">5 Jan,19</div>
                            </div>
                            <div class="tt-item">
                                <div class="tt-col-avatar">
                            ...
                            <div class="tt-item">
                                ...
                                <div class="tt-col-description">
                                    ...
                                    <div class="row align-items-center no-gutters hide-desktope">
                                        <div class="col-9">
                                            <ul class="tt-list-badge">
                                                <li class="show-mobile"><a href="#"><span
                                                            class="tt-color15 tt-badge">music</span></a></li>
                                            </ul>
                                        </div>
                                        <div class="col-3 ml-auto show-mobile">
                                            <div class="tt-value">5 Jan,19</div>
                                ...
                                <div class="tt-col-category"><a href="#"><span
                                            class="tt-color15 tt-badge">music</span></a></div>
                                <div class="tt-col-value-large hide-mobile">5 Jan,19</div>
                            </div>
                            <div class="tt-item">
                                <div class="tt-col-avatar">
                ...
                <div class="tt-modal-advancedSearch">
                    ...
                    <form class="form-default">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control pt-customInputSearch" id="searchForum"
