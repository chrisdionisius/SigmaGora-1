            ...
            <div class="row tt-row no-gutters">
                <div class="col-auto">
                    ...
                    <div class="tt-desktop-menu">
                        <nav>
                            <ul>
                                <li><a href="page-categories.html"><span>Kategori</span></a></li>
                                <li><a href="page-tabs.html"><span>Trending</span></a></li>
                                <li><a href="page-create-topic.html"><span>Terbaru</span></a></li>
                                <li>
                                    <a href="page-single-user.html"><span>Halaman</span></a>
                                    <ul>
                    ...
                    <div class="tt-search">
                        ...
                        <form class="search-wrapper">
                            <div class="search-form">
                                <input type="text" class="tt-search__input" placeholder="Cari">
                ...
                <div class="col-auto ml-auto">
                    <div class="tt-account-btn">
                        <a href="page-login.html" class="btn btn-primary">Masuk</a>
                        <a href="page-signup.html" class="btn btn-secondary">Daftar</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#">
                                            <span class="tt-color05 tt-badge">{{$categories->find($thread->category_id)->category_name}}</span></a>
                                    </li>
                                </ul>
                            </div>
